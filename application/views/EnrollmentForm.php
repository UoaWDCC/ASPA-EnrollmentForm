        ...
        <div class="content-block">
          ...
          <div id="div-page4" class="div-block page4">
            ...
            <div id="div-submit" class="div-okbtn div-submit">
              <div class="div-placeholder ok-btn-spaceholder btn-submit"></div><a id="submit" data-w-id="e789d92c-5d47-387a-12e6-10a0e389e4ba" href="#" class="button btn-submit w-button" onclick="<?php echo base_url()?>EnrollmentForm/send_email">SUBMIT</a>
              <p class="p-ok-btn-confirm p">Press<strong> Enter ↵</strong></p>
            </div>
